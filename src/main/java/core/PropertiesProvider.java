...
public class PropertiesProvider {
    ...
    static class DeviceProperties extends PropertiesParser {

        @Getter
        private final supportedOS platformSystem;
        @Getter
        ...
        @Getter
        private final Boolean autoAcceptAlert;
    ...
    static class CommonProperties extends PropertiesParser {
        @Getter
    ...
    static class IntegrationProperties extends PropertiesParser {
        @Getter
